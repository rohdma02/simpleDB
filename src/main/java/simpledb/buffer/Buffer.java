...
public class Buffer {
    ...
    private int txnum = -1;
    private int lsn = -1;
    private int timePinned;
    private int timeUnpinned;
    ...
    /**
     * Get time when the buffer was pinned
     * 
     * @return time when the buffer was pinned
     */
    public int getTimePinned() {
        return timePinned;
    }

    /**
     * Set time when the buffer was pinned
     * 
     * @param time
     */
    public void setTimePinned(int time) {
        this.timePinned = time;
    }
     ...
     * @param time
     */
    public void setTimeUnpinned(int time) {
        this.timeUnpinned = time;
    }
